...
### TESTS
#directory = "/home/devs/570/zproject/locating-objects-classes/mpii_human_pose_v1/images/"
#directory1 = '/home/devs/570/zproject/locating-objects-classes/dataset_256x256/20160613_F54_training_256x256/'
#dset = CSVDataset(directory=directory,
#                          max_dataset_size=20,
#                          ignore_gt=False,
#                          seed=0)
#dset1 = CSVDataset(directory=directory1,
#                          max_dataset_size=20,
#                          ignore_gt=False,
#                          seed=0)
#print(dset.__getitem__(0))
#print(dset1.__getitem__(0))
##########3 END TEST
...
class CSVDataset(torch.utils.data.Dataset):
    def __init__(self,
        ...
        with open("final_test2_ultrasmall_one_image.csv", "w") as gt_file:
            gt_writer = csv.writer(gt_file)
            gt_writer.writerow(self.csv_df.filename)
            gt_file.close()
            print("here")
    def __len__(self):
        if self.there_is_gt:
    ...
    def __getitem__(self, idx):
        ...
        if 'classes' in dictionary.keys():
            dictionary['classes'] = eval(dictionary['classes'])
#        dictionary['classes'] = [
#            list(cl) for cl in dictionary['classes']]
        ...
        with torch.no_grad():
            ...
            if 'classes' in dictionary.keys():
                dictionary['classes'] = torch.tensor(
                        dictionary['classes'], dtype=torch.get_default_dtype())
